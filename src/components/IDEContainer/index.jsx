...
const IDEContainer = () => {
  return (
    <div className='transform mx-4'>
      ...
      <SubCard title={'Meus serviços'} className={'absolute top-[40em] left-[47em] w-[33em] z-20'}>
        <div className="flex items-start gap-3 text-blue-primary border-b border-gray-600 py-4">
          ...
          <div>
            ...
            <p className="text-stone-400 text-xs">Um desenvolvimento focados na criação de sites, páginas únicas, E-commerce ou outras aplicações. Promovendo uma boa experiência e otimização de websites.</p>
          </div>
        </div>
        <div className="flex items-start gap-3 text-blue-primary border-b border-gray-600 py-4">
          <CheckIcon width={'45'} height={'20'}/>
          <div>
            ...
            <p className="text-stone-400 text-xs">Aplicações web responsivas, disponíveis para todos os dispositivos móveis, tornando os sites mais práticos e acessíveis, incluindo aplicações 100% móveis como apps.</p>
          </div>
        </div>
        <div className="flex items-start gap-3 text-blue-primary border-b border-gray-600 py-4">
          <CheckIcon width={'45'} height={'20'}/>
