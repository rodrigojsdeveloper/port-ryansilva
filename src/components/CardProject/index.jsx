  ...
  return (
    <div className="striped-background w-full mx-auto bg-white shadow-xl p-4 sm:p-8 rounded-lg mb-6">
      <div className="flex flex-col sm:flex-row items-center">
        <div className="brighter-image w-full sm:w-72 h-44 sm:h-60 bg-gradient-to-br from-black to-gray-300 shadow-md rounded-xl transform translate-x-0 sm:-translate-x-16 overflow-hidden relative my-4">
        ...
        <div className="w-full mt-4 sm:mt-0 sm:w-1/2 p-4">
          ...
          <p className={`${abel.className} text-gray-600 mt-4`}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Recusandae voluptate repellendus magni illo ea animi?</p>
          <div className="mt-6">
